...
ALTER TABLE biz_circulateitem modify (usedTime number(20));
ALTER TABLE biz_circulateitem_finished modify (usedTime number(20));
ALTER TABLE biz_workitem modify (usedTime number(20));
ALTER TABLE biz_workitem_finished modify (usedTime number(20));
ALTER TABLE biz_workflow_token modify (usedTime number(20));
ALTER TABLE biz_workflow_instance modify (usedTime number(20));
